...
var tabulateArgument = function (dictTabulate) {
    ...
    return {
        tabulate: function (f) {
            var g = tabulate3(function ($122) {
                return f(Data_Generic_Rep.Argument($122));
            });
            return function ($123) {
                return g((function (v) {
                    return v;
...
var tabulateChar = {
    tabulate: function (f) {
        var f1 = tabulate1(function ($125) {
            return f(fromJust(Data_Char.fromCharCode($125)));
        });
        return function ($126) {
            return f1(Data_Char.toCharCode($126));
        };
    }
};
var tabulateConstructor = function (dictTabulate) {
    ...
    return {
        tabulate: function (f) {
            var g = tabulate3(function ($127) {
                return f(Data_Generic_Rep.Constructor($127));
            });
            return function ($128) {
                return g((function (v) {
                    return v;
...
var tabulateEither = function (dictTabulate) {
    ...
    return function (dictTabulate1) {
        ...
        return {
            tabulate: function (f) {
                var r = tabulate4(function ($129) {
                    return f(Data_Either.Right.create($129));
                });
                var l = tabulate3(function ($130) {
                    return f(Data_Either.Left.create($130));
                });
                return function (v) {
...
var tabulateMaybe = function (dictTabulate) {
    ...
    return {
        tabulate: function (f) {
            ...
            var j = tabulate3(function ($131) {
                return f(Data_Maybe.Just.create($131));
            });
            return function (v) {
...
var tabulateSum = function (dictTabulate) {
    ...
    return function (dictTabulate1) {
        ...
        return {
            tabulate: function (f) {
                var r = tabulate4(function ($132) {
                    return f(Data_Generic_Rep.Inr.create($132));
                });
                var l = tabulate3(function ($133) {
                    return f(Data_Generic_Rep.Inl.create($133));
                });
                return function (v) {
...
var tabulateList = function (dictTabulate) {
    ...
    return {
        tabulate: function (f) {
            ...
            var f$prime = tabulate(tabulateMaybe(tabulateTuple1(tabulateList(dictTabulate))))(function ($134) {
                return f(toList($134));
            });
            return function ($135) {
                return f$prime(fromList($135));
            };
        }
    };
};
var tabulateArray = function (dictTabulate) {
    ...
    return {
        tabulate: function (f) {
            var f1 = tabulate3(function ($136) {
                return f(toUnfoldable($136));
            });
            return function ($137) {
                return f1(fromFoldable($137));
            };
        }
    };
};
...
var tabulateString = {
    tabulate: function (f) {
        var f1 = tabulate2(function ($138) {
            return f(Data_String_CodeUnits.fromCharArray($138));
        });
        return function ($139) {
            return f1(Data_String_CodeUnits.toCharArray($139));
        };
    }
};
