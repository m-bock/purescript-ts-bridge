...
var spec = /* #__PURE__ */ discard(/* #__PURE__ */ describe("patchClassFile")(/* #__PURE__ */ it("patches a class file correctly")(/* #__PURE__ */ (function () {
    ...
    return discard(describe("Data Type")(it("parses correctly")(shouldEqual(new Data_Maybe.Just(new TsBridgeGen_Types.DefData("Foo")))(bind(recResToMaybe(PureScript_CST.parseDecl("data Foo = Bar | Baz")))(TsBridgeGen_Core.getPursDef)))))(function () {
        return discard(describe("Value")(it("parses correctly")(shouldEqual(new Data_Maybe.Just(new TsBridgeGen_Types.DefUnsupportedExport("x", "value")))(bind(recResToMaybe(PureScript_CST.parseDecl("x :: Int")))(TsBridgeGen_Core.getPursDef)))))(function () {
            return discard(describe("Type Alias")(it("parses correctly")(shouldEqual(new Data_Maybe.Just(new TsBridgeGen_Types.DefType("Foo")))(bind(recResToMaybe(PureScript_CST.parseDecl("type Foo = Int")))(TsBridgeGen_Core.getPursDef)))))(function () {
