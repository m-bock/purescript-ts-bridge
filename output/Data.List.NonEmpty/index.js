...
var unionBy = /* #__PURE__ */ (function () {
    var $193 = wrappedOperation2("unionBy");
    return function ($194) {
        return $193(Data_List.unionBy($194));
    };
})();
...
var toUnfoldable = function (dictUnfoldable) {
    var $195 = Data_Unfoldable.unfoldr(dictUnfoldable)(function (xs) {
        return map(function (rec) {
            return new Data_Tuple.Tuple(rec.head, rec.tail);
        })(Data_List.uncons(xs));
    });
    return function ($196) {
        return $195(toList($196));
    };
};
var tail = function (v) {
    return v.value1;
...
var sortBy = /* #__PURE__ */ (function () {
    var $197 = wrappedOperation("sortBy");
    return function ($198) {
        return $197(Data_List.sortBy($198));
    };
})();
...
var singleton = /* #__PURE__ */ (function () {
    var $199 = Data_NonEmpty.singleton(Data_List_Types.plusList);
    return function ($200) {
        return Data_List_Types.NonEmptyList($199($200));
    };
})();
...
var nubByEq = /* #__PURE__ */ (function () {
    var $201 = wrappedOperation("nubByEq");
    return function ($202) {
        return $201(Data_List.nubByEq($202));
    };
})();
var nubBy = /* #__PURE__ */ (function () {
    var $203 = wrappedOperation("nubBy");
    return function ($204) {
        return $203(Data_List.nubBy($204));
    };
})();
...
var mapMaybe = function ($206) {
    return lift(Data_List.mapMaybe($206));
};
var partition = function ($207) {
    return lift(Data_List.partition($207));
};
var span = function ($208) {
    return lift(Data_List.span($208));
};
var take = function ($209) {
    return lift(Data_List.take($209));
};
var takeWhile = function ($210) {
    return lift(Data_List.takeWhile($210));
};
...
var intersectBy = /* #__PURE__ */ (function () {
    var $211 = wrappedOperation2("intersectBy");
    return function ($212) {
        return $211(Data_List.intersectBy($212));
    };
})();
...
var groupBy = /* #__PURE__ */ (function () {
    ...
    return function ($215) {
        return $214(Data_List.groupBy($215));
    };
})();
var groupAllBy = /* #__PURE__ */ (function () {
    var $216 = wrappedOperation("groupAllBy");
    return function ($217) {
        return $216(Data_List.groupAllBy($217));
    };
})();
...
var fromFoldable = function (dictFoldable) {
    var $218 = Data_List.fromFoldable(dictFoldable);
    return function ($219) {
        return fromList($218($219));
    };
};
...
var filterM = function (dictMonad) {
    var $220 = Data_List.filterM(dictMonad);
    return function ($221) {
        return lift($220($221));
    };
};
var filter = function ($222) {
    return lift(Data_List.filter($222));
};
...
var dropWhile = function ($223) {
    return lift(Data_List.dropWhile($223));
};
var drop = function ($224) {
    return lift(Data_List.drop($224));
};
