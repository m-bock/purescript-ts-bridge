...
var toTsBridgeC = {
    toTsBridge: function (v) {
        return TsBridge_Core.tsTypeVar("C");
    }
};
...
var toTsBridgeB = {
    toTsBridge: function (v) {
        return TsBridge_Core.tsTypeVar("B");
    }
};
var toTsBridgeA = {
    toTsBridge: function (v) {
        return TsBridge_Core.tsTypeVar("A");
    }
};
...
var toTsBridgeEither = function (dictToTsBridge) {
    var tsOpaqueType2 = TsBridge_Core.tsOpaqueType2(mappingMappingToTsBridgeT(toTsBridgeProxy(dictToTsBridge)));
    return function (dictToTsBridge1) {
        return {
            toTsBridge: tsOpaqueType2(mappingMappingToTsBridgeT(toTsBridgeProxy(dictToTsBridge1)))(Mp.value)("Data.Either")("Either")("A")("B")
        };
    };
};
var toTsBridgeProxy3 = /* #__PURE__ */ toTsBridgeProxy(/* #__PURE__ */ toTsBridgeEither(toTsBridgeString)(toTsBridgeBoolean));
var toTsBridge6 = /* #__PURE__ */ toTsBridge(toTsBridgeProxy3);
...
var toTsBridge7 = /* #__PURE__ */ toTsBridge(/* #__PURE__ */ toTsBridgeProxy(/* #__PURE__ */ toTsBridgeFunction(toTsBridgeString)(/* #__PURE__ */ toTsBridgeFunction(toTsBridgeNumber)(toTsBridgeBoolean))));
var toTsBridgeMaybe = function (dictToTsBridge) {
    return {
        toTsBridge: TsBridge_Core.tsOpaqueType1(mappingMappingToTsBridgeT(toTsBridgeProxy(dictToTsBridge)))(Mp.value)("Data.Maybe")("Maybe")("A")
    };
};
                ...
                return discard(describe("String")(testTypePrint(toTsBridge2(Type_Proxy["Proxy"].value))("string")))(function () {
                    return discard(describe("Boolean")(testTypePrint(toTsBridge3(Type_Proxy["Proxy"].value))("boolean")))(function () {
                        return discard(describe("Array")(testTypePrint(toTsBridge5(Type_Proxy["Proxy"].value))("Array<boolean>")))(function () {
                            return discard(describe("Function")(testTypePrint(toTsBridge7(Type_Proxy["Proxy"].value))("(_: string) => (_: number) => boolean")))(function () {
                                return discard(describe("Record")(testTypePrint(toTsBridge4(Type_Proxy["Proxy"].value))("{ readonly bar: string; readonly foo: number; }")))(function () {
                                    return discard(describe("Maybe")(testTypePrint(toTsBridge8(Type_Proxy["Proxy"].value))("Data_Maybe.Maybe<boolean>")))(function () {
                                        return describe("Either")(testTypePrint(toTsBridge6(Type_Proxy["Proxy"].value))("Data_Either.Either<string, boolean>"));
                                    });
                                });
                            });
                        });
