    ...
    var caseString = function (name) {
        ...
        if (Data_Boolean.otherwise) {
            ...
            var caseChar = function (c) {
                ...
                var $130 = Data_CodePoint_Unicode.isAlpha(Data_String_CodePoints.codePointFromChar(c));
                if ($130) {
                    var $131 = Data_String_CodeUnits.toChar(Data_String_Unicode.toLowerSimple(Data_String_CodeUnits.singleton(c)));
                    if ($131 instanceof Data_Maybe.Just) {
                        var $132 = Data_String_CodeUnits.toChar(Data_String_Unicode.toUpperSimple(Data_String_CodeUnits.singleton(c)));
                        if ($132 instanceof Data_Maybe.Just) {
                            return alt(Parsing_String["char"]($131.value0))(Parsing_String["char"]($132.value0));
                        };
                        return v1(true);
                    };
                    return v1(true);
...
var eof = /* #__PURE__ */ bind(Parsing.getParserT)(function (v) {
    var $146 = Data_List["null"](v.value0);
    if ($146) {
