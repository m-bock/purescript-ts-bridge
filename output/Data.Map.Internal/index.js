                        ...
                        var go = function (v) {
                            ...
                            if (v instanceof Two) {
                                return appendFn(appendFn((function () {
                                    var $815 = tooSmall(v.value1);
                                    if ($815) {
                                        return memptyValue;
                                    };
                                    return go(v.value0);
                                })())((function () {
                                    var $816 = inBounds(v.value1);
                                    if ($816) {
                                        return f(v.value1)(v.value2);
                                    };
                                    return memptyValue;
                                })()))((function () {
                                    var $817 = tooLarge(v.value1);
                                    if ($817) {
                                        return memptyValue;
                                    };
                                    return go(v.value3);
                            ...
                            if (v instanceof Three) {
                                return appendFn(appendFn(appendFn(appendFn((function () {
                                    var $822 = tooSmall(v.value1);
                                    if ($822) {
                                        return memptyValue;
                                    };
                                    return go(v.value0);
                                })())((function () {
                                    var $823 = inBounds(v.value1);
                                    if ($823) {
                                        return f(v.value1)(v.value2);
                                    };
                                    return memptyValue;
                                })()))((function () {
                                    var $824 = tooSmall(v.value4) || tooLarge(v.value1);
                                    if ($824) {
                                        return memptyValue;
                                    };
                                    return go(v.value3);
                                })()))((function () {
                                    var $825 = inBounds(v.value4);
                                    if ($825) {
                                        return f(v.value4)(v.value5);
                                    };
                                    return memptyValue;
                                })()))((function () {
                                    var $826 = tooLarge(v.value4);
                                    if ($826) {
                                        return memptyValue;
                                    };
                                    return go(v.value6);
...
var filterWithKey = function (dictOrd) {
    ...
    return function (predicate) {
        var $923 = Data_List_Lazy.filter(Data_Tuple.uncurry(predicate));
        return function ($924) {
            return fromFoldable1($923(toUnfoldable1($924)));
        };
    };
};
...
var filterKeys = function (dictOrd) {
    ...
    return function (predicate) {
        return filterWithKey1(function ($925) {
            return Data_Function["const"](predicate($925));
        });
    };
};
                        ...
                        return function ($copy_m) {
                            ...
                            function $tco_loop(v, v1, m) {
                                ...
                                if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
                                    var v2 = compare(v.value0.value0)(v1.value0.value0);
                                    if (v2 instanceof Data_Ordering.LT) {
                                        $tco_var_v = v.value1;
                                        $tco_var_v1 = v1;
                                        $copy_m = m;
...
var mapMaybe = function (dictOrd) {
    ...
    return function ($927) {
        return $926(Data_Function["const"]($927));
    };
};
        ...
        return function (k) {
            return function (v) {
                return alter1((function () {
                    var $930 = Data_Maybe.maybe(v)(Data_Function.flip(f)(v));
                    return function ($931) {
                        return Data_Maybe.Just.create($930($931));
                    };
                })())(k);
            };
        };
            ...
            return function (m2) {
                var go = function (k) {
                    return function (m) {
                        return function (v) {
                            return alter1((function () {
                                var $932 = Data_Maybe.maybe(v)(f(v));
                                return function ($933) {
                                    return Data_Maybe.Just.create($932($933));
                                };
                            })())(k)(m);
                        };
                    };
