...
var runGen = function ($102) {
    return Control_Monad_State.runState(unGen($102));
};
...
var replicateMRec = function (dictMonadRec) {
    ...
    return function (k) {
        return function (v) {
            ...
            var go = function (v1) {
                if (v1.value1 === 0) {
                    return pure2(new Control_Monad_Rec_Class.Done(v1.value0));
                };
                return mapFlipped(v)(function (x) {
                    return new Control_Monad_Rec_Class.Loop(new Data_Tuple.Tuple(new Data_List_Types.Cons(x, v1.value0), v1.value1 - 1 | 0));
                });
            };
            return tailRecM1(go)(new Data_Tuple.Tuple(Data_List_Types.Nil.value, k));
        };
    };
};
...
var perturbGen = function (n) {
    return function (gen) {
        return discard($$void(modify(function (s) {
            ...
            $90.newSeed = Random_LCG.lcgPerturb($foreign.float32ToInt32(n))(s.newSeed);
            return $90;
        })))(function () {
            return unGen(gen);
        });
...
var lcgStep = /* #__PURE__ */ (function () {
    var f = function (s) {
        return new Data_Tuple.Tuple(Random_LCG.unSeed(s.newSeed), (function () {
            ...
            $93.newSeed = Random_LCG.lcgNext(s.newSeed);
            return $93;
        })());
    };
    return state(f);
...
var evalGen = function ($103) {
    return Control_Monad_State.evalState(unGen($103));
};
...
var choose = function (a) {
    return function (b) {
        ...
        return map2((function () {
            var $104 = add(min$prime);
            var $105 = mul(max$prime - min$prime);
            return function ($106) {
                return unscale($104($105($106)));
            };
        })())(uniform);
    };
};
...
var frequency = function (xxs) {
    var total = unwrap(foldMap1(function ($107) {
        return Data_Monoid_Additive.Additive(Data_Tuple.fst($107));
    })(xxs));
...
var chooseInt$prime = function (a) {
    return function (b) {
        ...
        return map2(function ($108) {
            return Data_Int.floor(clamp($108));
