...
var simplify = function (v) {
    ...
    if (v instanceof Options_Applicative_Types.MultNode) {
        ...
        var v1 = bind(v.value0)(function ($337) {
    ...
    if (v instanceof Options_Applicative_Types.AltNode) {
        ...
        var v1 = bind(v.value0)(function ($338) {
...
var parseWord = /* #__PURE__ */ (function () {
    var go = function (v) {
        if (v instanceof Data_List_Types.Cons && (v.value0 === "-" && (v.value1 instanceof Data_List_Types.Cons && v.value1.value0 === "-"))) {
            return new Data_Maybe.Just((function () {
                ...
                return new OptWord(new Options_Applicative_Types.OptLong(Data_String_CodeUnits.fromCharArray(fromFoldable(v1.value0))), map(function ($339) {
                    return Data_String_CodeUnits.fromCharArray(fromFoldable($339));
                })(v1.value1));
            })());
        };
        if (v instanceof Data_List_Types.Cons && v.value0 === "-") {
            ...
            if (v.value1 instanceof Data_List_Types.Cons) {
                return new Data_Maybe.Just((function () {
                    ...
                    return new OptWord(new Options_Applicative_Types.OptShort(v.value1.value0), map(function ($340) {
                        return Data_String_CodeUnits.fromCharArray(fromFoldable($340));
                    })(arg));
                })());
            };
    ...
    var $341 = Data_List.fromFoldable(Data_Foldable.foldableArray);
    return function ($342) {
        return go($341(Data_String_CodeUnits.toCharArray($342)));
    };
})();
                ...
                if (opt instanceof Options_Applicative_Types.FlagReader) {
                    return discard1(guard(has_name(v.value0)(opt.value0)))(function () {
                        return discard1(guard(is_short(v.value0) || Data_Maybe.isNothing(v.value1)))(function () {
                            return new Data_Maybe.Just(bind3(get)(function (args) {
                                var val$prime = map(function ($343) {
                                    return (function (s) {
                                        return Data_Array.cons("-")(s);
                                    })(Data_String_CodeUnits.toCharArray($343));
                                })(v.value1);
                                return discard2(put(Data_Maybe.maybe(args)((function () {
                                    var $344 = Data_Function.flip(Data_List_Types.Cons.create)(args);
                                    return function ($345) {
                                        return $344(Data_String_CodeUnits.fromCharArray($345));
                                    };
                                })())(val$prime)))(function () {
...
var evalParser = function (v) {
    ...
    if (v instanceof Options_Applicative_Types.BindP) {
        return Control_Monad_Free["resume$prime"](function (p) {
            return function (k) {
                return bind1(evalParser(p))(function ($346) {
                    return evalParser(Options_Applicative_Types.BindP.create(k($346)));
                });
            };
                ...
                return function (p) {
                    ...
                    if (v instanceof Options_Applicative_Types.ForwardOptions) {
                        ...
                        if (v1 instanceof Data_Maybe.Just) {
                            return alt1(searchOpt1(pprefs)(v1.value0)(p))(searchArg(dictMonadP)(pprefs)(arg)(p));
                        };
                ...
                return function (args) {
                    ...
                    var newPolicy = function (a) {
                        if (policy instanceof Options_Applicative_Types.NoIntersperse) {
                            var $296 = Data_Maybe.isJust(parseWord(a));
                            if ($296) {
