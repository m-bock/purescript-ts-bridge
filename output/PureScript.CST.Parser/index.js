...
var bindFlipped = /* #__PURE__ */ Control_Bind.bindFlipped(PureScript_CST_Parser_Monad.bindParser);
...
var layout = function (valueParser) {
    var tail = PureScript_CST_Parser_Monad.many(applySecond(tokLayoutSep)(valueParser));
    var go = function (head) {
        return map(Data_Array.cons(head))(tail);
    };
    var values = alt(bindFlipped(go)(valueParser))(pure([  ]));
    return applyFirst(applySecond(tokLayoutStart)(values))(tokLayoutEnd);
};
...
var parseTypeParen = function (open) {
    return bind($lazy_parseType(515))(function (value) {
        return bind(tokRightParen)(function (close) {
...
var parseRowTailParen = function (open) {
    return bind(apply(map(Data_Tuple.Tuple.create)(tokPipe))($lazy_parseType(485)))(function (tail) {
        return bind(tokRightParen)(function (close) {
            return pure(new PureScript_CST_Types.TypeRow({
                open: open,
                value: {
...
var parseRowParen = function (open) {
    return bind(PureScript_CST_Parser_Monad["try"](apply(map(Data_Tuple.Tuple.create)(parseLabel))(tokDoubleColon)))(function (v) {
        return bind($lazy_parseType(467))(function (value) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)(tokComma))($lazy_parseRowLabel(468))))(function (rest) {
                return bind(PureScript_CST_Parser_Monad.optional(apply(map(Data_Tuple.Tuple.create)(tokPipe))($lazy_parseType(469))))(function (tail) {
                    return bind(tokRightParen)(function (close) {
                        return pure(new PureScript_CST_Types.TypeRow({
                            open: open,
                            value: {
...
var parseKindedVar = function (open) {
    return bind(PureScript_CST_Parser_Monad["try"](apply(map(Data_Tuple.Tuple.create)(parens(map(PureScript_CST_Types.TypeVar.create)(parseIdent))))(tokDoubleColon)))(function (v) {
        return bind($lazy_parseType(505))(function (kind) {
            return bind(tokRightParen)(function (close) {
                return pure(new PureScript_CST_Types.TypeParens({
                    open: open,
...
var $lazy_parseForall = /* #__PURE__ */ $runtime_lazy("parseForall", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return apply(apply(apply(map(PureScript_CST_Types.TypeForall.create)(tokForall))(many1($lazy_parseTypeVarBinding(536))))(tokDot))($lazy_parseType1(538));
    });
});
var $lazy_parseRow = /* #__PURE__ */ $runtime_lazy("parseRow", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind(PureScript_CST_Parser_Monad.optional(separated(tokComma)($lazy_parseRowLabel(521))))(function (labels) {
            return bind(PureScript_CST_Parser_Monad.optional(apply(map(Data_Tuple.Tuple.create)(tokPipe))($lazy_parseType(522))))(function (tail) {
                return pure({
                    labels: labels,
                    tail: tail
                });
...
var $lazy_parseRowLabel = /* #__PURE__ */ $runtime_lazy("parseRowLabel", "PureScript.CST.Parser", function () {
    return bind(parseLabel)(function (label) {
        return bind(tokDoubleColon)(function (separator) {
            return bind($lazy_parseType(529))(function (value) {
                return pure({
                    label: label,
                    separator: separator,
                    value: value
...
var $lazy_parseType = /* #__PURE__ */ $runtime_lazy("parseType", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseType1(401))(function (ty) {
            return alt(apply(map(PureScript_CST_Types.TypeKinded.create(ty))(tokDoubleColon))($lazy_parseType(402)))(pure(ty));
        });
    });
});
var $lazy_parseType1 = /* #__PURE__ */ $runtime_lazy("parseType1", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt($lazy_parseForall(407))($lazy_parseType2(408));
    });
});
var $lazy_parseType2 = /* #__PURE__ */ $runtime_lazy("parseType2", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseType3(412))(function (ty) {
            return alt(apply(map(PureScript_CST_Types.TypeArrow.create(ty))(tokRightArrow))($lazy_parseType1(413)))(alt(apply(map(PureScript_CST_Types.TypeConstrained.create(ty))(tokRightFatArrow))($lazy_parseType1(414)))(pure(ty)));
        });
    });
});
var $lazy_parseType3 = /* #__PURE__ */ $runtime_lazy("parseType3", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseType4(419))(function (ty) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)(parseQualifiedOperator))($lazy_parseType4(420))))(function (ops) {
...
var $lazy_parseType4 = /* #__PURE__ */ $runtime_lazy("parseType4", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt(parseTypeNegative)($lazy_parseType5(427));
    });
});
var $lazy_parseType5 = /* #__PURE__ */ $runtime_lazy("parseType5", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseTypeAtom(431))(function (ty) {
            return bind(PureScript_CST_Parser_Monad.many($lazy_parseTypeAtom(432)))(function (args) {
                return pure((function () {
...
var $lazy_parseTypeVarBinding = /* #__PURE__ */ $runtime_lazy("parseTypeVarBinding", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt($lazy_parseTypeVarKinded(542))(map(PureScript_CST_Types.TypeVarName.create)(parseIdent));
    });
});
var $lazy_parseTypeVarKinded = /* #__PURE__ */ $runtime_lazy("parseTypeVarKinded", "PureScript.CST.Parser", function () {
    return map(PureScript_CST_Types.TypeVarKinded.create)(parens(bind(parseIdent)(function (label) {
        return bind(tokDoubleColon)(function (separator) {
            return bind($lazy_parseType(549))(function (value) {
                return pure({
                    label: label,
                    separator: separator,
                    value: value
...
var parseForall = /* #__PURE__ */ $lazy_parseForall(532);
var parseRow = /* #__PURE__ */ $lazy_parseRow(519);
var parseRowLabel = /* #__PURE__ */ $lazy_parseRowLabel(525);
var parseType = /* #__PURE__ */ $lazy_parseType(399);
var parseType1 = /* #__PURE__ */ $lazy_parseType1(405);
var parseType2 = /* #__PURE__ */ $lazy_parseType2(410);
var parseType3 = /* #__PURE__ */ $lazy_parseType3(417);
var parseType4 = /* #__PURE__ */ $lazy_parseType4(425);
var parseType5 = /* #__PURE__ */ $lazy_parseType5(429);
var parseTypeAtom = /* #__PURE__ */ $lazy_parseTypeAtom(437);
var parseTypeParens = /* #__PURE__ */ $lazy_parseTypeParens(450);
var parseTypeVarBinding = /* #__PURE__ */ $lazy_parseTypeVarBinding(540);
var parseTypeVarKinded = /* #__PURE__ */ $lazy_parseTypeVarKinded(545);
...
var $lazy_parseBinder = /* #__PURE__ */ $runtime_lazy("parseBinder", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseBinder1(806))(function (binder) {
...
var $lazy_parseBinder1 = /* #__PURE__ */ $runtime_lazy("parseBinder1", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseBinder2(812))(function (binder) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)(parseQualifiedOperator))($lazy_parseBinder2(813))))(function (ops) {
                return pure((function () {
                    var v1 = Data_Array_NonEmpty.fromArray(ops);
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return binder;
...
var $lazy_parseBinderConstructor = /* #__PURE__ */ $runtime_lazy("parseBinderConstructor", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind(parseQualifiedProper)(function (name) {
            return bind(PureScript_CST_Parser_Monad.many($lazy_parseBinderAtom(833)))(function (apps) {
...
var $lazy_parseIdentBinder = /* #__PURE__ */ $runtime_lazy("parseIdentBinder", "PureScript.CST.Parser", function () {
    return bind(parseIdent)(function (ident) {
        return alt(apply(map(PureScript_CST_Types.BinderNamed.create(ident))(tokAt))($lazy_parseBinderAtom(853)))(pure(new PureScript_CST_Types.BinderVar(ident)));
    });
});
var parseBinder = /* #__PURE__ */ $lazy_parseBinder(804);
var parseBinder1 = /* #__PURE__ */ $lazy_parseBinder1(810);
var parseBinder2 = /* #__PURE__ */ $lazy_parseBinder2(818);
var parseBinderAtom = /* #__PURE__ */ $lazy_parseBinderAtom(836);
var parseBinderConstructor = /* #__PURE__ */ $lazy_parseBinderConstructor(830);
var parseIdentBinder = /* #__PURE__ */ $lazy_parseIdentBinder(850);
...
var parseRecordUpdates = function (expr) {
    return bind(PureScript_CST_Parser_Monad["try"](applyFirst(tokLeftBrace)(PureScript_CST_Parser_Monad.lookAhead(applySecond(parseLabel)(alt(tokEquals)(tokLeftBrace))))))(function (open) {
        return bind(separated(tokComma)($lazy_parseRecordUpdate(690)))(function (value) {
...
var parseRecordUpdateLeaf = function (label) {
    return apply(map(PureScript_CST_Types.RecordUpdateLeaf.create(label))(tokEquals))($lazy_parseExpr(704));
};
var parseRecordUpdateBranch = function (label) {
    return map(PureScript_CST_Types.RecordUpdateBranch.create(label))(braces(separated(tokComma)($lazy_parseRecordUpdate(709))));
};
...
var parseGuarded = function (sepParser) {
    ...
    })(PureScript_CST_Parser_Monad.optional(PureScript_CST_Parser_Monad["try"](apply(map(Data_Tuple.Tuple.create)(parseBinder))(tokLeftArrow)))))($lazy_parseExpr(795));
    ...
    return alt(apply(map(PureScript_CST_Types.Unconditional.create)(sepParser))($lazy_parseWhere(781)))(map(PureScript_CST_Types.Guarded.create)(many1(parseGuardedExpr)));
};
var parseBadSingleCaseWhere = function (binder) {
    return bind(tokRightArrow)(function (arrow) {
        return bind(applySecond(tokLayoutEnd)($lazy_parseWhere(659)))(function (body) {
...
var $lazy_parseAdo = /* #__PURE__ */ $runtime_lazy("parseAdo", "PureScript.CST.Parser", function () {
    return bind(tokQualifiedKeyword("ado"))(function (keyword) {
        return bind(layout(recoverDoStatement($lazy_parseDoStatement(676))))(function (statements) {
            return bind(tokKeyword("in"))(function (in_) {
                return bind($lazy_parseExpr(678))(function (result) {
...
var $lazy_parseCase = /* #__PURE__ */ $runtime_lazy("parseCase", "PureScript.CST.Parser", function () {
    return bind(tokKeyword("case"))(function (keyword) {
        return bind(separated(tokComma)($lazy_parseExpr(641)))(function (head) {
            return bind(tokKeyword("of"))(function (of_) {
                return bind(alt(PureScript_CST_Parser_Monad["try"]($lazy_parseBadSingleCaseBranch(643)))($lazy_parseCaseBranches(643)))(function (branches) {
...
var $lazy_parseDo = /* #__PURE__ */ $runtime_lazy("parseDo", "PureScript.CST.Parser", function () {
    return bind(tokQualifiedKeyword("do"))(function (keyword) {
        return bind(layoutNonEmpty(recoverDoStatement($lazy_parseDoStatement(670))))(function (statements) {
...
var $lazy_parseDoStatement = /* #__PURE__ */ $runtime_lazy("parseDoStatement", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt(apply(map(PureScript_CST_Types.DoLet.create)(tokKeyword("let")))(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(752)))))(alt(apply(map(Data_Tuple.uncurry(PureScript_CST_Types.DoBind.create))(PureScript_CST_Parser_Monad["try"](apply(map(Data_Tuple.Tuple.create)(parseBinder))(tokLeftArrow))))($lazy_parseExpr(753)))(map(PureScript_CST_Types.DoDiscard.create)($lazy_parseExpr(754))));
    });
});
var $lazy_parseExpr = /* #__PURE__ */ $runtime_lazy("parseExpr", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr1(554))(function (expr) {
...
var $lazy_parseExpr1 = /* #__PURE__ */ $runtime_lazy("parseExpr1", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr2(560))(function (expr) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)(parseQualifiedOperator))($lazy_parseExpr2(561))))(function (ops) {
                return pure((function () {
                    var v1 = Data_Array_NonEmpty.fromArray(ops);
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return expr;
...
var $lazy_parseExpr2 = /* #__PURE__ */ $runtime_lazy("parseExpr2", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr3(568))(function (expr) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)($lazy_parseTickExpr(569)))($lazy_parseExpr3(569))))(function (ops) {
                return pure((function () {
                    var v1 = Data_Array_NonEmpty.fromArray(ops);
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return expr;
...
var $lazy_parseExpr3 = /* #__PURE__ */ $runtime_lazy("parseExpr3", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt(apply(map(PureScript_CST_Types.ExprNegate.create)(tokKeyOperator("-")))($lazy_parseExpr3(591)))($lazy_parseExpr4(592));
    });
});
var $lazy_parseExpr4 = /* #__PURE__ */ $runtime_lazy("parseExpr4", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr5(596))(function (expr) {
            return bind(PureScript_CST_Parser_Monad.many($lazy_parseExpr5(597)))(function (args) {
                return pure((function () {
                    var v1 = Data_Array_NonEmpty.fromArray(args);
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return expr;
...
var $lazy_parseExpr5 = /* #__PURE__ */ $runtime_lazy("parseExpr5", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt($lazy_parseIf(604))(alt($lazy_parseLetIn(605))(alt($lazy_parseLambda(606))(alt($lazy_parseCase(607))(alt($lazy_parseDo(608))(alt($lazy_parseAdo(609))($lazy_parseExpr6(610)))))));
    });
});
var $lazy_parseExpr6 = /* #__PURE__ */ $runtime_lazy("parseExpr6", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr7(683))(function (expr) {
...
var $lazy_parseExpr7 = /* #__PURE__ */ $runtime_lazy("parseExpr7", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExprAtom(713))(function (expr) {
...
var $lazy_parseIf = /* #__PURE__ */ $runtime_lazy("parseIf", "PureScript.CST.Parser", function () {
    return bind(tokKeyword("if"))(function (keyword) {
        return bind($lazy_parseExpr(615))(function (cond) {
            return bind(tokKeyword("then"))(function (then_) {
                return bind($lazy_parseExpr(617))(function (true_) {
                    return bind(tokKeyword("else"))(function (else_) {
                        return bind($lazy_parseExpr(619))(function (false_) {
...
var $lazy_parseLambda = /* #__PURE__ */ $runtime_lazy("parseLambda", "PureScript.CST.Parser", function () {
    return bind(tokBackslash)(function (symbol) {
        return bind(many1(parseBinderAtom))(function (binders) {
            return bind(tokRightArrow)(function (arrow) {
                return bind($lazy_parseExpr(635))(function (body) {
...
var $lazy_parseLetBinding = /* #__PURE__ */ $runtime_lazy("parseLetBinding", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return alt(PureScript_CST_Parser_Monad["try"]($lazy_parseIdentBinding(758)))(apply(apply(map(PureScript_CST_Types.LetBindingPattern.create)(parseBinder1))(tokEquals))($lazy_parseWhere(759)));
    });
});
var $lazy_parseLetIn = /* #__PURE__ */ $runtime_lazy("parseLetIn", "PureScript.CST.Parser", function () {
    return bind(tokKeyword("let"))(function (keyword) {
        return bind(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(625))))(function (bindings) {
            return bind(tokKeyword("in"))(function (in_) {
...
var $lazy_parseTickExpr = /* #__PURE__ */ $runtime_lazy("parseTickExpr", "PureScript.CST.Parser", function () {
    return bind(tokTick)(function (open) {
        return bind($lazy_parseTickExpr1(577))(function (value) {
...
var $lazy_parseTickExpr1 = /* #__PURE__ */ $runtime_lazy("parseTickExpr1", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr3(583))(function (expr) {
            return bind(PureScript_CST_Parser_Monad.many(apply(map(Data_Tuple.Tuple.create)(parseQualifiedOperator))($lazy_parseExpr3(584))))(function (ops) {
                return pure((function () {
                    var v1 = Data_Array_NonEmpty.fromArray(ops);
                    if (v1 instanceof Data_Maybe.Nothing) {
                        return expr;
...
var $lazy_parseWhere = /* #__PURE__ */ $runtime_lazy("parseWhere", "PureScript.CST.Parser", function () {
    return defer(function (v) {
        return bind($lazy_parseExpr(800))(function (expr) {
            return bind(PureScript_CST_Parser_Monad.optional(apply(map(Data_Tuple.Tuple.create)(tokKeyword("where")))(layoutNonEmpty(recoverLetBinding($lazy_parseLetBinding(801))))))(function (bindings) {
                return pure({
                    expr: expr,
                    bindings: bindings
                });
...
var parseAdo = /* #__PURE__ */ $lazy_parseAdo(673);
var parseBadSingleCaseBranch = /* #__PURE__ */ $lazy_parseBadSingleCaseBranch(650);
var parseCase = /* #__PURE__ */ $lazy_parseCase(638);
var parseCaseBranches = /* #__PURE__ */ $lazy_parseCaseBranches(646);
var parseDo = /* #__PURE__ */ $lazy_parseDo(667);
var parseDoStatement = /* #__PURE__ */ $lazy_parseDoStatement(750);
var parseExpr = /* #__PURE__ */ $lazy_parseExpr(552);
var parseExpr1 = /* #__PURE__ */ $lazy_parseExpr1(558);
var parseExpr2 = /* #__PURE__ */ $lazy_parseExpr2(566);
var parseExpr3 = /* #__PURE__ */ $lazy_parseExpr3(589);
var parseExpr4 = /* #__PURE__ */ $lazy_parseExpr4(594);
var parseExpr5 = /* #__PURE__ */ $lazy_parseExpr5(602);
var parseExpr6 = /* #__PURE__ */ $lazy_parseExpr6(681);
var parseExpr7 = /* #__PURE__ */ $lazy_parseExpr7(711);
var parseExprAtom = /* #__PURE__ */ $lazy_parseExprAtom(723);
var parseIdentBinding = /* #__PURE__ */ $lazy_parseIdentBinding(761);
var parseIf = /* #__PURE__ */ $lazy_parseIf(612);
var parseLambda = /* #__PURE__ */ $lazy_parseLambda(630);
var parseLetBinding = /* #__PURE__ */ $lazy_parseLetBinding(756);
var parseLetIn = /* #__PURE__ */ $lazy_parseLetIn(622);
var parseRecordUpdate = /* #__PURE__ */ $lazy_parseRecordUpdate(694);
var parseTickExpr = /* #__PURE__ */ $lazy_parseTickExpr(574);
var parseTickExpr1 = /* #__PURE__ */ $lazy_parseTickExpr1(581);
var parseWhere = /* #__PURE__ */ $lazy_parseWhere(798);
