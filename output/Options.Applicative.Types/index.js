...
var readerAbort = /* #__PURE__ */ (function () {
    var $476 = Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(monadExceptT);
    var $477 = Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Data_Identity.monadIdentity));
    return function ($478) {
...
var readMApplicative = {
    pure: /* #__PURE__ */ (function () {
        var $482 = Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity)));
        return function ($483) {
...
var oneM = function ($499) {
    return ParserM(Control_Monad_Free.liftF($499));
};
    ...
    map: function (f) {
        return function (v) {
            ...
            if (v instanceof BindP) {
                return new BindP(map3(f)(v.value0));
            };
