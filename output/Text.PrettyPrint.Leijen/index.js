...
var renderCompact = /* #__PURE__ */ (function () {
    ...
    var $288 = scan(0);
    return function ($289) {
        return $288(Data_List.singleton($289));
    };
})();
                            ...
                            return function (ds) {
                                return function (x) {
                                    return function (y) {
                                        ...
                                        var $214 = fits(w)(min(n)(k))(width$prime)(x$prime);
                                        if ($214) {
                                            return x$prime;
                                        };
...
var docShow = {
    show: /* #__PURE__ */ (function () {
        var $294 = renderPretty(0.4)(80);
        return function ($295) {
            return displayS($294($295));
        };
    })()
};
...
var string = /* #__PURE__ */ (function () {
    var $296 = Data_Foldable.intercalate(Data_Foldable.foldableArray)(docMonoid)(line);
    var $297 = Data_Functor.map(Data_Functor.functorArray)(text);
    var $298 = Data_String_Common.split("\x0a");
    return function ($299) {
...
var cat = function ($300) {
    return group(vcat($300));
};
...
var sep = function ($301) {
    return group(vsep($301));
};
