...
var escTitle = /* #__PURE__ */ (function () {
    var rex = fromJust(Data_Either.hush(Data_String_Regex.regex("#")(Data_String_Regex.parseFlags("g"))));
    return Data_String_Regex.replace(rex)("");
})();
var escMsg = /* #__PURE__ */ (function () {
    var rex = fromJust(Data_Either.hush(Data_String_Regex.regex("^")(Data_String_Regex.parseFlags("gm"))));
    return Data_String_Regex.replace(rex)("  ");
})();
