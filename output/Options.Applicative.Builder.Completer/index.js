...
var requote = /* #__PURE__ */ (function () {
    ...
    var $55 = Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray);
    var $56 = Data_List.fromFoldable(Data_Foldable.foldableArray);
    return function ($57) {
        return Data_String_CodeUnits.fromCharArray($55(go$prime($56(Data_String_CodeUnits.toCharArray($57)))));
    };
})();
...
var listCompleter = function ($58) {
    return listIOCompleter(pure($58));
};
