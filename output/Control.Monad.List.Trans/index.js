...
var wrapEffect = function (dictFunctor) {
    ...
    return function (v) {
        return map2(function ($331) {
            return Skip.create(Data_Lazy.defer(Data_Function["const"]($331)));
        })(v);
    };
};
...
var drop = function (dictApplicative) {
    ...
    return function (v) {
        return function (fa) {
            ...
            var f = function (v1) {
                if (v1 instanceof Yield) {
                    return new Skip(map1(drop(dictApplicative)(v - 1 | 0))(v1.value1));
                };
                if (v1 instanceof Skip) {
                    return new Skip(map1(drop(dictApplicative)(v))(v1.value0));
                };
                if (v1 instanceof Done) {
                    return Done.value;
                };
...
var monadEffectListT = function (dictMonadEffect) {
    ...
    return {
        liftEffect: (function () {
            var $332 = lift(Monad0);
            var $333 = Effect_Class.liftEffect(dictMonadEffect);
            return function ($334) {
                return $332($333($334));
            };
        })(),
