    ...
    foldr: function (f) {
        return function (i) {
            return function (v) {
                ...
                throw new Error("Failed pattern match at Test.Spec.Tree (line 58, column 1 - line 63, column 32): " + [ f.constructor.name, i.constructor.name, v.constructor.name ]);
            };
        };
    },
    foldl: function (f) {
    ...
    return function (v) {
        return {
            ...
            example: function (aroundAction) {
                return v.example(function ($184) {
                    return aroundAction(action($184));
                });
            }
        };
    };
